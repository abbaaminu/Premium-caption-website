...
export default function App() {
  ...
  // Centralised download handler — now uses OneDrive direct link
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4" id="specs-bento-grid">
                      <div className="rounded-xl border border-gray-200 bg-white p-5 dark:border-white/5 dark:bg-white/5">
                        ...
                        <p className="text-xs text-gray-500 dark:text-slate-400 mt-2">Provides a native hardware-accelerated desktop interface with responsive slider offsets and transparency controllers.</p>
                      </div>
                      <div className="rounded-xl border border-gray-200 bg-white p-5 dark:border-white/5 dark:bg-white/5">
                        ...
                        <p className="text-xs text-gray-500 dark:text-slate-400 mt-2">Local speech recognition engine decoding voice tracks directly from your primary speaker output. No API keys needed.</p>
                      </div>
                      <div className="rounded-xl border border-gray-200 bg-white p-5 dark:border-white/5 dark:bg-white/5">
                        ...
                        <p className="text-xs text-gray-500 dark:text-slate-400 mt-2">Auto-captures the current video timeline over active local socket parameters. Works seamlessly with VLC Player and MPV out-of-the-box.</p>
                      </div>
                      <div className="rounded-xl border border-gray-200 bg-white p-5 dark:border-white/5 dark:bg-white/5">
                        ...
                        <p className="text-xs text-gray-500 dark:text-slate-400 mt-2">Precompiled native binaries for Windows 10/11, macOS Apple Silicon processors, and major Linux AppImage systems.</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center">
                  <div className="mx-auto max-w-3xl">
                    ...
                    <p className="mt-4 text-sm text-gray-600 dark:text-slate-300">
                      Unpack the portable launcher and run the offline dictionary downloader during your initial setup. No administrative privileges required for execution.
                    </p>
                    <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
                      ...
                      <div className="rounded-2xl border border-gray-200 bg-gray-50/50 p-6 dark:border-white/5 dark:bg-white/5">
                        <h3 className="font-bold text-sm text-gray-900 dark:text-white">Windows Installer</h3>
                        <p className="text-[11px] text-gray-500 dark:text-slate-400 mt-2">For Windows 10 & 11 (64-bit)</p>
                        <a href={DOWNLOAD_URL} onClick={handleDriveDownload} className="mt-4 inline-flex items-center gap-1 text-xs font-bold text-sky-500 dark:text-sky-400 hover:underline">
                      ...
                      <div className="rounded-2xl border border-sky-300 bg-sky-50/10 p-6 dark:border-sky-500/30 dark:bg-white/5">
                        <h3 className="font-bold text-sm text-gray-900 dark:text-white flex items-center justify-center gap-1">
                          macOS Package
                          <span className="rounded bg-sky-100 px-1.5 py-0.5 text-[9px] font-bold text-sky-800 dark:bg-white/10 dark:text-sky-300">Coming Soon</span>
                        </h3>
                        <p className="text-[11px] text-gray-500 dark:text-slate-400 mt-2">For Apple Silicon Macs (M1/M2/M3/M4)</p>
                        <span className="mt-4 inline-flex items-center gap-1 text-xs font-bold text-gray-400 dark:text-slate-500">
              ...
              <section className="bg-gray-50 py-16 dark:bg-[#0B1120] border-t border-gray-100 dark:border-white/5" id="faqs-section">
                <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="space-y-6">
                    {[
                      { q: "Why is the Premium plan priced at exactly $1/Month?", a: "We believe offline accessibility and computer privacy should remain accessible. Charging a humble subscription of $1/month allows us to cover continuous updates of local dictionary libraries, verify Vosk builds on newer operating systems, and handle support mailboxes, while keeping the app affordable." },
                      { q: "How will my card be charged and managed?", a: "Checkouts are handled securely via Paystack and Paddle. Paddle serves as our Merchant of Record for international payments. Your payment information is protected under PCI-DSS standards. You are billed $1.00 USD on a monthly cycle and can cancel at any time by contacting tukurmuhammed902@gmail.com." },
                      { q: "How is speech processed locally using the Vosk API?", a: "When running the desktop application, all vocal recognition and text transcription is handled on your computer's local CPU threads. The Vosk neural network language models are bundled directly into your application. Your videos, movies, and audio logs are NEVER transmitted to external cloud systems or databases." },
